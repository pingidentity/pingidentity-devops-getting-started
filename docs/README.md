...
* **Learn to use Ping Identity provided images** - if you are looking to learn how to use docker images that are _built and maintained_ by Ping to achieve the mentioned benefits of containerization: 
  ...
  2. Go through the [examples](https://pingidentity-devops.gitbook.io/devops/examples) as tutorials. Start with [quickstart](https://app.gitbook.com/@pingidentity-devops/s/devops/examples/quickstart) as it contains important setup and background. Then skip ahead if you are comfortable.
